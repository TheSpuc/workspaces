...
public class Test {
	...
	public static void main(String[] args) {
		...
		Student s1 = new Student(6, "Vicki");
		s1.addGrade(12);
		s1.addGrade(12);
		s1.addGrade(12);
		s1.addGrade(12);
		Student s2 = new Student(6, "Henrik");
		s2.addGrade(10);
		s2.addGrade(10);
		s2.addGrade(10);
		s2.addGrade(10);
		Student s3 = new Student(4, "Simon");
		s3.addGrade(7);
		s3.addGrade(7);
		s3.addGrade(7);
		s3.addGrade(7);
		Student s4 = new Student(3, "Casper");
		s4.addGrade(4);
		s4.addGrade(4);
		s4.addGrade(4);
		s4.addGrade(4);
		Student s5 = new Student(2, "Hans");
		s5.addGrade(2);
		s5.addGrade(2);
		s5.addGrade(2);
		s5.addGrade(2);
		Student s6 = new Student(1, "Simon");
		s6.addGrade(0);
		s6.addGrade(0);
		s6.addGrade(0);
		s6.addGrade(0);
