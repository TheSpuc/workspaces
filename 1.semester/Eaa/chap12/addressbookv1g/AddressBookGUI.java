...
public class AddressBookGUI extends JFrame
{
		...
		add.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ev)
			{
				book.addDetails(new ContactDetails(nameField.getText(),
						phoneField.getText(), address.getText()));
			}
		});
	...
	private Container setupSearchArea()
	{
		...
		JScrollPane scrollArea = new JScrollPane(resultList,
	...
	private Container setupListArea()
	{
		...
		JScrollPane scrollArea = new JScrollPane(details,
				JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
				JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
