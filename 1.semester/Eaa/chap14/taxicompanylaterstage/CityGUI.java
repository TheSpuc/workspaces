package chap14.taxicompanylaterstage;
...
public class CityGUI extends JFrame implements Actor
{
	...
	{
		cityView.preparePaint();
		Iterator<Object> items = city.getItems();
		while (items.hasNext()) {
	...
	private class CityView extends JPanel
	{
		...
		{
			return new Dimension(cityWidth * VIEW_SCALING_FACTOR, cityHeight
					* VIEW_SCALING_FACTOR);
		}
		...
		public void paintComponent(Graphics g)
		{
			if (cityImage != null) {
				...
				if (size.equals(currentSize)) {
					...
					g.drawImage(cityImage, 0, 0, currentSize.width,
