 ...
 * @version 1.0
 */
public class MusicPlayerGUI extends JFrame implements ChangeListener,
		ActionListener
{
...
//	}
	...
	{
		JOptionPane.showMessageDialog(this, "Music Player\n" + VERSION,
				"About Music Player", JOptionPane.INFORMATION_MESSAGE);
	}
	...
	private void makeFrame()
	{
		...
		JPanel leftPane = new JPanel();
		{
			...
			JComboBox<String> formatList = new JComboBox<String>(ordering);
		...
		JPanel centerPane = new JPanel();
		{
			...
			slider.setBorder(new CompoundBorder(new EmptyBorder(6, 10, 10, 10),
					border));
