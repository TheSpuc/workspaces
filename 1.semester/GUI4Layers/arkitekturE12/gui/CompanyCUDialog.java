...
/**
 * The CompanyCUDialog class implements a view that shows a single company. The
 * view is used by the user to create or update a company.<br />
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == btnOk) {
				...
				if (name.length() == 0) {
					...
					/**** update storage ****/
					if (company == null) {
						company = Service.createCompany(name, hours);
//						 
					} else {
