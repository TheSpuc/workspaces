...
/**
 * The EmployeeFrame class implements a view that shows all employees. The view
...
public class EmployeeFrame extends JFrame {
	...
	public EmployeeFrame() {
		...
		lstEmployees = new JList<Employee>();
	...
	private class Controller implements ActionListener, ListSelectionListener {
		public void fillLstEmployees() {
			lstEmployees.setListData(Service.getEmployees().toArray(new Employee[0]));
		}
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == btnCreate) {
				EmployeeCUDialog createEmployeeDialog = new EmployeeCUDialog(
						EmployeeFrame.this, "Create New Employee");
				...
				if (lstEmployees.getSelectedIndex() != -1) {
					...
					EmployeeCUDialog updateEmployeeDialog = new EmployeeCUDialog(
							EmployeeFrame.this, "Update Employee");
					Employee employee = (Employee) lstEmployees
							.getSelectedValue();
					...
					updateEmployeeDialog.dispose(); // release MS Windows
													// resources
				}
			}
				...
				if (index != -1) {
					int answer = JOptionPane.showConfirmDialog(
							EmployeeFrame.this, "Are you sure?",
