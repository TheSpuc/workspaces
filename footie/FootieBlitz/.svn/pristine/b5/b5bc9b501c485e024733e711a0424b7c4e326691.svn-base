		...
		<table class="table">
			...
			<tbody>
				<tr>
					...
					<td class="align-center"><?php echo $this->Html->link($newestUser['User'][$config['userMap']['username']], array('controller' => 'forumusers', 'action' => 'edit', $newestUser['Profile']['id'], 'admin' => true)); ?></td>
				</tr>
			</tbody>
		</table>
	</div>
				...
				<tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
					...
					<td>	
						<?php if ($report['Report']['itemType'] == Report::TOPIC && !empty($report['Topic']['id'])) {
							...
							echo $this->Html->link($report['User'][$config['userMap']['username']], array('controller' => 'forumusers', 'action' => 'edit', $report['User']['id'], 'admin' => true));
					...
					<td><?php echo $this->Html->link($report['Reporter'][$config['userMap']['username']], array('controller' => 'forumusers', 'action' => 'edit', $report['Reporter']['id'], 'admin' => true)); ?></td>
	...
	<div class="containerContent">
		<table class="table">
			...
			<tbody>
				...
				<tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
					<td><?php echo $this->Html->link($latest['User'][$config['userMap']['username']], array('controller' => 'forumusers', 'action' => 'edit', $latest['Profile']['id'], 'admin' => true)); ?></td>
					...
					<td class="align-center">
						<?php echo $this->Html->link(__d('forum', 'Edit'), array('controller' => 'forumusers', 'action' => 'edit', $latest['Profile']['id'], 'admin' => true)); ?>
					</td>
				</tr>
