...
<p><?php printf(__d('forum', 'To find the users ID, you can search for them on the %s.'), $this->Html->link(__d('forum', 'Users listing'), array('controller' => 'forumusers', 'action' => 'index', 'admin' => true))); ?></p>
