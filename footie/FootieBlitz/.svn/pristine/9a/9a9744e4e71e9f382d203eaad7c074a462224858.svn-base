...
<?php if ($method == 'add') { ?>
	<p><?php printf(__d('forum', 'To find the users ID, you can search for them in the %s.'), $this->Html->link(strtolower(__d('forum', 'Users listing')), array('controller' => 'forumusers', 'action' => 'index', 'admin' => true))); ?></p>
<?php }
