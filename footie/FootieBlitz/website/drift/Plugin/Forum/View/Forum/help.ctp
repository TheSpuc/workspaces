...
<p><strong><?php echo __d('forum', 'Why can\'t I login?'); ?></strong><br />
<?php echo __d('forum', 'The server might be having technicaly difficulties so your request could not be processed. It may also be that your account has been deleted or banned.'); ?></p>
...
<p><strong><?php echo __d('forum', 'What are moderators, super moderators and administrators?'); ?></strong><br />
...
<p><strong><?php echo __d('forum', 'What does the power search do?'); ?></strong><br />
<?php echo __d('forum', 'By default the search will only search for terms within the topic title. If you check the power search, it will search within the title and post.'); ?></p>

<p><strong><?php echo __d('forum', 'How do I edit my profile?'); ?></strong><br />
<?php printf(__d('forum', 'Once you have logged in, you can edit your profile by going to the %s link, located at the top right.'), $this->Html->link('edit profile', array('controller' => 'forumusers', 'action' => 'edit'))); ?></p>

<p><strong><?php echo __d('forum', 'How do I post a topic?'); ?></strong><br />
...
<p><strong><?php echo __d('forum', 'How do I post a reply?'); ?></strong><br />
...
<p><strong><?php echo __d('forum', 'How do I create a poll?'); ?></strong><br />
...
<p><strong><?php echo __d('forum', 'How do I edit my topic, poll, post, etc?'); ?></strong><br />
...
<p><strong><?php echo __d('forum', 'How do I report a topic, post or user?'); ?></strong><br />
<?php echo __d('forum', 'At the top right of each post you would click the "Report <content>" link. From there you should add a comment on why you are reporting this content.'); ?></p>

<p><strong><?php echo __d('forum', 'How do I get higher access and permissions?'); ?></strong><br />
<?php echo __d('forum', 'It is up to the administrator to give you higher access. All you can do is be a superb member on the forum and hope they promote you.'); ?></p>

<p><strong><?php echo __d('forum', 'I have more questions that aren\'t shown here!'); ?></strong><br />
<?php printf(__d('forum', 'If you have additional questions and need further help, please contact us at %s.'), $settings['site_email']); ?></p>