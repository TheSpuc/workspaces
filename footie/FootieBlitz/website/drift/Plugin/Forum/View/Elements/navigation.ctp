...
<div class="navigation">
	...
	if ($user) {
		...
		$links[] = $this->Html->link(__d('forum', 'Dashboard'), array('controller' => 'forumusers', 'action' => 'dashboard', 'admin' => false));
	...
	if ($user) { ?>
		...
		<div>
			<?php echo sprintf(__d('forum', 'Welcome %s'), $this->Html->link($user['User'][$config['userMap']['username']], array('controller' => 'forumusers', 'action' => 'profile', $user['User']['id'], 'admin' => false))); ?>
		</div>
