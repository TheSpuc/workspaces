...
<div style="float: right;">
	<h3><?PHP echo "Userpoints: " . $usern['0']['User']['userpoints']; ?></h3>
	<?PHP  
	if ($usern['0']['User']['userpoints'] >= 25){ 
		echo $this->Html->link('Create a new player', array('plugin' => null,'controller' => 'person', 'action' =>'newplayer'));
	} 
	?>
 </div>
