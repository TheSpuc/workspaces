...
<div class="title">
	<?php echo $this->Html->link(__d('forum', 'Edit Profile'), array('controller' => 'forumusers', 'action' => 'edit', 'admin' => false), array('class' => 'button float-right')); ?>	
		...
		<table class="table">
			...
			<?php foreach ($subscriptions as $counter => $topic) { ?>
				...
				<tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
					...
					<td class="author">
						<?php echo $this->Html->link($topic['Topic']['User'][$config['userMap']['username']], array('controller' => 'forumusers', 'action' => 'profile', $topic['Topic']['User']['id'])); ?>
					</td>
					...
					<td class="activity">
						...
						if (!empty($topic['Topic']['LastUser'])) { ?>
							<span class="gray"><?php echo __d('forum', 'by'); ?> <?php echo $this->Html->link($topic['Topic']['LastUser'][$config['userMap']['username']], array('controller' => 'forumusers', 'action' => 'profile', $topic['Topic']['lastUser_id'])); ?></span>
						<?php } ?>
					</td>
				</tr>
				...
				<tr<?php if ($counter % 2) echo ' class="altRow"'; ?>>
					...
					<td class="activity">
						...
						if (!empty($topic['LastUser'])) { ?>
							<span class="gray"><?php echo __d('forum', 'by'); ?> <?php echo $this->Html->link($topic['LastUser'][$config['userMap']['username']], array('controller' => 'forumusers', 'action' => 'profile', $topic['Topic']['lastUser_id'])); ?></span>
						<?php } ?>
					</td>
				</tr>
