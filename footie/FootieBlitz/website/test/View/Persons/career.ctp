...
$totalGames = $totalGames + $info[0]['matches'];
echo '<td>' . $info[0]['assists'] . '</td>';
$totalAssists = $totalAssists + $info[0]['assists'];
echo '<td>' . $info[0]['goals'] . '</td>';
$totalGoals = $totalGoals + $info[0]['goals'];
echo '<td>' . $info[0]['rating'] . '</td>';
echo '</tr>';
}
echo '<tr><td>Total</td><td></td><td></td><td>' . $totalGames . '</td><td>' . $totalAssists . '</td><td>' . $totalGoals . '</td><td></td></tr>';
